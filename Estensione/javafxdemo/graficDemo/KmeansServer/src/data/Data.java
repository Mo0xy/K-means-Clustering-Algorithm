...
public class Data {
	 ...
	 */
	public Data(String dbName, String userID, String psw,String table) throws DatabaseConnectionException, SQLException, EmptySetException, NoValueException {


		database = new DbAccess("127.0.0.1", dbName, userID, psw);
		...
		try {
			...
			throw new EmptySetException(e.getMessage());
		}
	 ...
	 *
	 * @return array di indici dei centroidi.
	 *
	...
	double computePrototype(Set<Integer> clusteredSet, ContinuousAttribute attribute){
		double sum = 0;
		for(Integer index : clusteredSet){
			sum += (Double) getAttributeValue(index, attribute.getIndex());
		}
